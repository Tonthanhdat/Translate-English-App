# Translate-English-App - Application to support learning English using Java
...
## 💡 My Contributions (Ton Thanh Dat - 23020354)
- Implemented the core functionalities of the application, including:
  - Dictionary search (English-Vietnamese & Vietnamese-English)
  - Word management (add, edit, delete, save)
  - Pronunciation feature
- Assisted in building the Practice Game (game logic & scoring system)
- Integrated functionalities with the UI built by team members
- Ensured proper application flow following the MVC architecture
